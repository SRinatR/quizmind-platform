...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "User_createdAt_id_asc_idx"
  ON "User" ("createdAt" ASC, "id" ASC);

CREATE INDEX CONCURRENTLY IF NOT EXISTS "User_lastLoginAt_id_idx"
  ON "User" ("lastLoginAt" DESC, "id" DESC);

CREATE INDEX CONCURRENTLY IF NOT EXISTS "User_email_id_idx"
  ON "User" ("email" ASC, "id" ASC);

CREATE INDEX CONCURRENTLY IF NOT EXISTS "User_suspendedAt_idx"
  ON "User" ("suspendedAt");

CREATE INDEX CONCURRENTLY IF NOT EXISTS "User_emailVerifiedAt_idx"
  ON "User" ("emailVerifiedAt");

CREATE INDEX CONCURRENTLY IF NOT EXISTS "UserSystemRole_userId_role_idx"
  ON "UserSystemRole" ("userId", "role");

CREATE INDEX CONCURRENTLY IF NOT EXISTS "UserSystemRole_role_userId_idx"
  ON "UserSystemRole" ("role", "userId");

CREATE INDEX CONCURRENTLY IF NOT EXISTS "User_email_lower_trgm_idx"
  ON "User" USING GIN (LOWER("email") gin_trgm_ops);

CREATE INDEX CONCURRENTLY IF NOT EXISTS "User_displayName_lower_trgm_idx"
